...
def Pig(primary_color,secondary_color):
    app = Ursina()
    ...
    for x in range(2):
        for y in range(0,8):
            if y == 4:
                ...
                b = Entity(model="cube",color = primary_color ,position = (x+6,y,0))
    ...
    #NARIZ
    for x in range(2,6):
        b = Entity(model="cube",color = secondary_color ,position = (x,3,0))
        b = Entity(model="cube",color = secondary_color  ,position = (x,1,0))
    #medio nariz
    for x in range(2):
        if x == 1:
            b = Entity(model="cube",color = rgb(255,100,100) ,position = (x+3,2,0))
