...
def Skeleton(primary_color,secondary_color):
    app = Ursina()
    #fila 0
    ...
    Entity(model='cube', color=secondary_color , position=(2,4))
    Entity(model='cube', color=primary_color, position=(2,5))
    ...
    Entity(model='cube', color=secondary_color , position=(6, 4))
    Entity(model='cube', color=primary_color, position=(6, 5))
    ...
    Entity(model='cube', color=secondary_color , position=(7, 4))
