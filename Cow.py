...
def Cow(primary_color,secondary_color):
    ...
    for x in range (1,7):
        b = Entity(model="cube",color = primary_color ,position = (x,3,0))
    for y in range(3,7):
        b = Entity(model="cube",color = primary_color, position = (2,y,0))
    for x in range(4,6):
        b = Entity(model="cube",color = primary_color, position = (x,4,0))
    b = Entity(model="cube",color = primary_color, position = (5,5,0))
    ...
    for i in range (2):
        for x in range(6,8):
            for y in range (6,8):
                b = Entity(model="cube",color = primary_color , position = (x,y,0))
    for i in range (2):
        for x in range(2):
            for y in range (6,8):
                b= Entity(model="cube",color = primary_color , position = (x,y,0))
    b = Entity(model="cube",color = primary_color , position = (2,7,0))

    #alrededor de boca
    b = Entity(model="cube",color = secondary_color,position = (1,0,0))
    b = Entity(model="cube",color = secondary_color,position = (6,0,0))
    b = Entity(model="cube",color = secondary_color,position = (1,1,0))
    b = Entity(model="cube",color = secondary_color,position = (6,1,0))


        #parte superior de boca
    for x in range (4):
        b = Entity(model="cube",color = secondary_color,position = (2+x,2,0))
    ...
    for x in range (3,5):
        b = Entity(model="cube",color = rgb(105, 105, 105),position = (x,1,0))
    b  = Entity(model="cube",color =primary_color ,position = (1,2,0))
    b  = Entity(model="cube",color =primary_color ,position = (6,2,0))
