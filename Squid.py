...
def Squid(primary_color, secondary_color):
    app = Ursina()
    ...
    Entity(model='cube', color=primary_color, position=(1, 4))
    Entity(model='cube', color=primary_color, position=(1, 5))
    ...
    Entity(model='cube', color=secondary_color, position=(3, 1))
    Entity(model='cube', color=secondary_color, position=(3, 2))
    Entity(model='cube', color=secondary_color, position=(3, 3))
    Entity(model='cube', color=color.white, position=(3, 4))
    Entity(model='cube', color=color.white, position=(3, 5))
    Entity(model='cube', color=secondary_color, position=(3, 6))
    Entity(model='cube', color=primary_color, position=(3, 7))

    # columna 4

    Entity(model='cube', color=secondary_color, position=(4, 1))
    Entity(model='cube', color=secondary_color, position=(4, 2))
    ...
    Entity(model='cube', color=secondary_color, position=(4, 6))
    ...
    Entity(model='cube', color=secondary_color, position=(5, 4))
    Entity(model='cube', color=secondary_color, position=(5, 5))
    Entity(model='cube', color=secondary_color, position=(5, 6))
    Entity(model='cube', color=primary_color, position=(5, 7))

    # columna 6

    Entity(model='cube', color=secondary_color, position=(6, 1))
    Entity(model='cube', color=secondary_color, position=(6, 2))
    Entity(model='cube', color=secondary_color, position=(6, 3))
    Entity(model='cube', color=color.white, position=(6, 4))
    Entity(model='cube', color=color.white, position=(6, 5))
    Entity(model='cube', color=secondary_color, position=(6, 6))
    Entity(model='cube', color=primary_color, position=(6, 7))

    # columna 7

    Entity(model='cube', color=primary_color, position=(7, 1))
    Entity(model='cube', color=secondary_color, position=(7, 2))
    Entity(model='cube', color=secondary_color, position=(7, 3))
    Entity(model='cube', color=color.white, position=(7, 4))
    Entity(model='cube', color=color.black, position=(7, 5))
